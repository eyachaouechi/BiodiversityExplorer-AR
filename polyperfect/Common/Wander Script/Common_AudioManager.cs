...
namespace Polyperfect.Common
{
  public class Common_AudioManager : MonoBehaviour
  {
    ...
    [SerializeField]
    private float soundMinDistance = 7f;

    [SerializeField]
    private float soundMaxDistance = 7f;
    ...
    private void Awake()
    {
      ...
      for (int i = 0; i < objectPoolLength; i++)
      {
        ...
        audioSource.minDistance = instance.soundMinDistance;
        audioSource.maxDistance = instance.soundMaxDistance; 
